...
<body>
			...
			<div class="col-md-12">
				<div id="header_area">
					<header class="center_content">
						<div class="logo pull-left"><a href="/GD-GatherDove"><img src="/images/logo2.png" alt="GATHER DOVE" /></a></div>
							<ul id="menu" class="header_right pull-right">
								<li><a href="/GD-GatherDove/About">About</a></li>
								<li class="active"><a href="/GD-GatherDove/signIn">Login</a></li>
	...
	<div class="popup_area modal fade" id="sign_up_popup" role="dialog">
		<div class="popup_holder modal-dialog">
			...
			<h2>Sign Up</h2>
			<form action="/GD-GatherDove/Register" method="post" id="su-register-form" name="su-form_register" class="form-horizontal" autocomplete="off">
